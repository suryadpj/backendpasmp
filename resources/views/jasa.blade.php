                ...
                <form id="sample_form">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" name="search_material"
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" id="sample_form2" class="form-horizontal"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Biaya Jasa</label>
                                                <div class="col-sm-7">
                                                    <input type="number" class="form-control" name="jasa"
                                                        id="jasa" placeholder="Biaya jasa">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Biaya PPN</label>
                                                <div class="col-sm-7">
                                                    <input type="number" class="form-control" name="ppn"
                                                        id="ppn" placeholder="Biaya PPN">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer justify-content-between">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#create_record').click(function() {
                ...
                $('.modal-title').text("Data Jasa Baru");
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#jasa').val(html.data.jasa);
                        $('#ppn').val(html.data.ppn);
                        $('#hidden_id').val(html.data.id);
                        $('.modal-title').text("Edit Data Jasa");

                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" id="sample_form2" class="form-horizontal"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Material</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="material"
                                                        id="material" placeholder="Material">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="harga"
                                                        id="harga" placeholder="Harga Material">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer justify-content-between">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#user_table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.search_material = $('input[name=search_material]').val();
                    }
                },
                columns: [{
                        "data": null,
            ...
            $('#create_record').click(function() {
                ...
                $('.modal-title').text("Data Material Baru");
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#material').val(html.data.material);

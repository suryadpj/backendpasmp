...
@section('title', 'Master Data Trade in')

@section('content_header')
    <h3>Data Master Trade In</h3>
@stop
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" name="search_merk"
                                        placeholder="Search nama merk">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" name="search_model"
                                    ...
                                    <form method="post" id="sample_form2" class="form-horizontal"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Merk</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="merk"
                                                        id="merk" placeholder="nama merk">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Type</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="type"
                                                        id="type" placeholder="nama Type">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Model</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="model"
                                                        id="model" placeholder="nama Model">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Tahun</label>
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Harga Minimum</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="harga_min"
                                                        id="harga_min" placeholder="Harga minimum">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Harga Maksimum</label>
                                                <div class="col-sm-7">
                                                    <input type="number" class="form-control" name="harga_max"
                                                        id="harga_max" placeholder="Hagra Maksimum">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer justify-content-between">
        ...
        $(document).ready(function() {
            ...
            var oTable = $('#user_table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.search_merk = $('input[name=search_merk]').val();
                        d.search_model = $('input[name=search_model]').val();
                    }
                },
                columns: [{
                        "data": null,
            ...
            $('#create_record').click(function() {
                ...
                $('.modal-title').text("Data Master Trade in Baru");
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#harga_min').val(html.data.harga_min);
                        $('#harga_max').val(html.data.harga_max);
                        $('#hidden_id').val(html.data.ID);
                        $('.modal-title').text("Edit Data Tradein");

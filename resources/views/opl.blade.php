                ...
                <form id="sample_form">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" name="search_opl"
                                        placeholder="Search opl">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" id="sample_form2" class="form-horizontal"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Keterangan OPL</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="opl"
                                                        id="opl" placeholder="nama Opl">
                                                </div>
                                            </div>
                                            <div class="form-group row">
            ...
            var oTable = $('#user_table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.search_opl = $('input[name=search_opl]').val();
                    }
                },
                columns: [{
                        "data": null,

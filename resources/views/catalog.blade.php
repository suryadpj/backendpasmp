...
@section('title', 'Master Data Katalog')
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" name="search_judul"
                                        placeholder="Judul Katalog">
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" name="search_ringkasan"
                                    ...
                                    <form method="post" id="sample_form2" class="form-horizontal"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="area" class="col-sm-5 col-form-label">Segmen</label>
                                                <div class="col-sm-7">
                                                    <select class="form-control" name="segmen" id="segmen"
                                                        style="width: 100%;">
                                                        <option value=''>Pilih Segmen</option>
                                                        <option value='1'>Our Product</option>
                                                        <option value='2'>Service berkala</option>
                                                        <option value='3'>Pekerjaan Lain</option>
                                                        <option value='4'>Body & paint</option>
                                                        <option value='5'>TCO</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="judul"
                                                        id="judul" placeholder="Judul Katalog">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Ringkasan</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="ringkasan"
                                                        id="ringkasan" placeholder="ringkasan">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="nilai" class="col-sm-5 col-form-label">Gambar Depan /
                                                    tumbnail</label>
                                                <div class="col-sm-7">
                                                    <span id="lampiran"></span>
                                                    <input type="file" name="gambardepan" class="form-control"
                                                        accept="image/jpeg,image/png,image/jpg">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Gambar 1</label>
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-5">
                                                            <select name="gambar_type1" id="gambar_type1" class="form-control"
                                                                style="width: 100%;">
                                                                <option value=''>Pilih Segmen</option>
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Gambar 2</label>
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-5">
                                                            <select name="gambar_typ2" id="gambar_type2" class="form-control"
                                                                style="width: 100%;">
                                                                <option value=''>Pilih Segmen</option>
                                                                <option value='1'>Foto</option>
                                                                <option value='2'>Video</option>
                                            ...
                                            <div class="form-group row">
                                                <label for="perihal" class="col-sm-5 col-form-label">Gambar 3</label>
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-5">
                                                            <select name="gambar_type3" id="gambar_type3" class="form-control"
                                                                style="width: 100%;">
                                                                <option value=''>Pilih Segmen</option>
                                                                <option value='1'>Foto</option>
                                                                <option value='2'>Video</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="textarea" name="penjelasan" id="penjelasan" placeholder="Place some text here"
        ...
        $(document).ready(function() {
            ...
            var oTable = $('#user_table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.search_judul = $('input[name=search_judul]').val();
                        d.search_ringkasan = $('input[name=search_ringkasan]').val();
                    }
                },
                columns: [{
                        "data": null,
            ...
            $('#create_record').click(function() {
                ...
                $('.modal-title').text("Data Katalog Baru");
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        $("#segmen").val(html.data.segmen).trigger("change");
                        $('#judul').val(html.data.judul);
                        $('#ringkasan').val(html.data.ringkasan);
                        if (html.data.gambardepan != "") {
                            $('#lampiran').html(
                                '<a target="_blank" href="storage/katalog/gambardepan/' +
                                html.data.gambardepan + '">download gambar existing</a>');
                        } else {
                            $('#lampiran').html('');
                        }

                        if (html.data.source != "") {
                            let gambar1 = html.data.source;
                            const a = gambar1.split('_');
                            console.log(a[0])
                            $("#gambar_type1").val(a[0]).trigger("change");
                        } else {
                            $("#gambar_type1").val(0).trigger("change");
                        }
                        if (html.data.source2 != "") {
                            let gambar1 = html.data.source2;
                            const a = gambar1.split('_');
                            console.log(a[0])
                            $("#gambar_type2").val(a[0]).trigger("change");
                        } else {
                            $("#gambar_type2").val('').trigger("change");
                        }
                        if (html.data.source3 != "") {
                            let gambar1 = html.data.source3;
                            const a = gambar1.split('_');
                            console.log(a[0])
                            $("#gambar_type3").val(a[0]).trigger("change");
                        } else {
                            $("#gambar_type3").val('').trigger("change");
                        }
                        $('.textarea').summernote('code', html.data.penjelasan);
